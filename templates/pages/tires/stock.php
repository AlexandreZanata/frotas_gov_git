...
<head>
    ...
    <link rel="stylesheet" href="<?php echo BASE_URL; ?>/assets/css/create_user.css"> <link rel="stylesheet" href="<?php echo BASE_URL; ?>/assets/css/manage_users.css"> <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.2/css/all.min.css">
</head>
<body>
        ...
        <div class="content-body">
            <div class="form-container">
                ...
                <form action="<?php echo BASE_URL; ?>/tires/stock/store" method="POST" class="user-form">
                    ...
                    <div class="form-row">
                        ...
                        <?php if ($_SESSION['user_role_id'] == 1): // Apenas Admin Geral seleciona a secretaria ?>
                        <div class="form-group">
                            <label for="secretariat_id">Secretaria *</label>
                            <select name="secretariat_id" required>
            ...
            <div class="table-container">
                 ...
                 <table class="user-table">
                     <thead><tr><th>DOT</th><th>Marca/Modelo</th><th>Secretaria</th><th>Status</th><th>Vida Útil</th><th>Data de Criação</th></tr></thead>
                     <tbody>
                        <?php if (empty($tiresInStock)): ?>
                            <tr><td colspan="6" style="text-align: center;">Nenhum pneu no estoque.</td></tr>
                        <?php else: ?>
                            ...
                            <tr>
                                ...
                                <td><?php echo htmlspecialchars($tire['secretariat_name'] ?? 'N/A'); ?></td>
                                <td><span class="status-badge status-available"><?php echo htmlspecialchars($tire['status']); ?></span></td>
